...
** Learn to use the following command line utilities
*** popd, pushd
    Special navigation commands
*** less
    Used for viewing a file
*** cal
    A nifty utility that's convenient to have around
*** du
    Useful for finding out disk usage
...
* Homework
** [insert good tmux tutorial here]